...
class Messbill extends StatefulWidget {
  const Messbill({Key key}) : super(key: key);
...
class _MessbillState extends State<Messbill> {
  ...
  List<Map> infolist=[];
  void count(){
    FirebaseDatabase.instance.reference().child("Messbill").once().then((onvalue) {
  ...
  Future readdata()async
  {
    ...
    postsRef.once().then((DataSnapshot snap) {
      Map<dynamic,dynamic> values = snap.value["Messbill"];
  ...
  Widget PostsUI(String age, String amount, String description,
      String semester, String image, String name) {
    return Padding(
